...
// Removed Users.css import if not needed, as styling is now based on Bootstrap classes
  ...
  return (
    <div className="container mt-5">
      ...
      <div className="table-responsive">
        <table className="table table-bordered border-warning mt-2" aria-label="Users Table">
